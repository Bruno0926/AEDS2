...
void setPerson(char* diretorio, StarWars* Personagens);
bool fim(char* entrada);
StarWars* clone(StarWars* x);
void retorno(StarWars* temp);
...
int main()
{
	...
	while (!fim(entrada->string)) 
	{

		Personagens = new_StarWars();
		setPerson(entrada->string,Personagens);
