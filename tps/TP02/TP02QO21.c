...
{
    char camArq[200];
    int contTam = 1, numeroComparacoes = 0, numeroMovimentacoes = 0;
    ...
    ordenaPorHeapsort(listaPersonagem, contTam, k, ptrComp, ptrMov);

    ordenaPorInsercao(listaPersonagem, contTam, ptrComp, ptrMov);
