...
public class TP02QO13 {
    public static void main(String[] args) throws Exception {
        MyIO.setCharset("ISO-8859-1");
        long inicialTemp = System.currentTimeMillis(); // Gravar tempo de início de execução
        ...
        while (testaFim(camArq) == false) {
            ...
            listPersons.inserir(montaPersonagem(camArq));

            camArq = MyIO.readLine().replaceAll("é", "\u00e9");
        }

        listPersons.ordenaPorHeapsort(); // Ordenar por Heapsort
        listPersons.ordenaPorInsercao(); // Ordenar os nomes com alturas iguais por Inserção

        listPersons.imprimeResultados(); // Imprimir os resultados

        listPersons.criarLog(inicialTemp); // Passar o tempo de início da execução
