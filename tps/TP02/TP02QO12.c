...
int main(void)
{
    ...
    ordenaPorShellsort(listaPersonagem, contTam, ptrComp, ptrMov); // Ordena peso por Shellsort, mas não troca os nomes, por ser instável

    ordenaPorInsercao(listaPersonagem, contTam, ptrComp, ptrMov); // Ordena peso e nome por Inserção, por ser estável
