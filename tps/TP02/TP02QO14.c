...
int main(void)
{
    ...
    ordenaPorQuicksort(listaPersonagem, 0, (contTam - 1), ptrComp, ptrMov); // Ordena peso por Quicksort, mas não troca os nomes, por ser instável

    ordenaPorInsercao(listaPersonagem, contTam, ptrComp, ptrMov); // Ordena cor do cabelo e nome por Inserção, por ser estável
